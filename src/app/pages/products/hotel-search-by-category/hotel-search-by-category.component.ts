...
@Component({
  selector: 'laeventa-hotel-search-by-category',
  templateUrl: './hotel-search-by-category.component.html',
  styleUrls: ['./hotel-search-by-category.component.scss']
})
export class HotelSearchComponentByCategory implements OnInit {
  ...
  getProductsh(){
    this.appService.getHotelsByCategory(this.category).subscribe(
        (productsh: any) => {
