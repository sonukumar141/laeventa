...
@Component({
  selector: 'laeventa-productv-search',
  templateUrl: './productv-search.component.html',
  styleUrls: ['./productv-search.component.scss']
})
export class ProductvSearchComponent implements OnInit {
